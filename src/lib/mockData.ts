...
export const demoTasks: VolunteerTask[] = [
  {
    ...
    taskLeaderVolunteerId: "v1",
    taskLeaderName: "Ana Rivera",
    locationId: "demo-lobby",
  ...
  },
  {
    ...
    taskLeaderVolunteerId: "v2",
    taskLeaderName: "Mateo Garcia",
    locationId: "demo-auditorium",
    locationName: "Auditorium",
    locationFloor: "Main",
    locationZone: "Sanctuary",
    skillTags: ["setup"],
    createdAt: new Date(),
    updatedAt: new Date()
  }
